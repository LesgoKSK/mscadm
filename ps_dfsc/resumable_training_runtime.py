"""Atomic epoch checkpoints around the publication training command."""
...
from .training_v4 import train_calibrator
...
def train_command(args) -> None:
    ...
    metadata = {
        "schema": "ps_dfsc_epoch_resume_metadata_v1",
        ...
        **kwargs,
        ...
        def save_epoch(state):
            ...
            torch.save(
                {
                    "metadata": metadata,
                    "midpoint_refresh_completed": refresh_flag["completed"],
                    "state": state,
                },
                temporary_path,
            )
